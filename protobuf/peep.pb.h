...
typedef enum _ClientCommandType {
    ...
    ClientCommandType_CLIENT_COMMAND_SYNC_TIME = 2
} ClientCommandType;
#define _ClientCommandType_MIN ClientCommandType_CLIENT_COMMAND_UNKNOWN
#define _ClientCommandType_MAX ClientCommandType_CLIENT_COMMAND_SYNC_TIME
#define _ClientCommandType_ARRAYSIZE ((ClientCommandType)(ClientCommandType_CLIENT_COMMAND_SYNC_TIME+1))

typedef enum _ClientInquiryType {
    ClientInquiryType_CLIENT_INQUIRY_UNKNOWN = 0,
    ClientInquiryType_CLIENT_INQUIRY_ENCODING_VERSION = 1,
    ClientInquiryType_CLIENT_INQUIRY_HATCH_CONFIGURATION = 2
} ClientInquiryType;
#define _ClientInquiryType_MIN ClientInquiryType_CLIENT_INQUIRY_UNKNOWN
#define _ClientInquiryType_MAX ClientInquiryType_CLIENT_INQUIRY_HATCH_CONFIGURATION
#define _ClientInquiryType_ARRAYSIZE ((ClientInquiryType)(ClientInquiryType_CLIENT_INQUIRY_HATCH_CONFIGURATION+1))

typedef enum _ClientMessageType {
    ClientMessageType_CLIENT_MESSAGE_UNKNOWN = 0,
    ClientMessageType_CLIENT_MESSAGE_COMMAND = 1,
    ClientMessageType_CLIENT_MESSAGE_INQUIRY = 2
} ClientMessageType;
#define _ClientMessageType_MIN ClientMessageType_CLIENT_MESSAGE_UNKNOWN
#define _ClientMessageType_MAX ClientMessageType_CLIENT_MESSAGE_INQUIRY
#define _ClientMessageType_ARRAYSIZE ((ClientMessageType)(ClientMessageType_CLIENT_MESSAGE_INQUIRY+1))
...
typedef enum _DeviceMessageType {
    ...
    DeviceMessageType_DEVICE_MESSAGE_INQUIRY_RESULT = 2
} DeviceMessageType;
#define _DeviceMessageType_MIN DeviceMessageType_DEVICE_MESSAGE_UNKNOWN
#define _DeviceMessageType_MAX DeviceMessageType_DEVICE_MESSAGE_INQUIRY_RESULT
#define _DeviceMessageType_ARRAYSIZE ((DeviceMessageType)(DeviceMessageType_DEVICE_MESSAGE_INQUIRY_RESULT+1))

/* Struct definitions */
typedef struct _ClientCommandSyncTime {
    uint64_t unix_epoch;
/* @@protoc_insertion_point(struct:ClientCommandSyncTime) */
} ClientCommandSyncTime;

typedef struct _ClientInquiry {
    ClientInquiryType type;
/* @@protoc_insertion_point(struct:ClientInquiry) */
} ClientInquiry;
...
typedef struct _ClientCommand {
    ClientCommandType type;
    ClientCommandConfigureHatch cofigure_hatch;
    ClientCommandSyncTime sync_time;
...
typedef struct _DeviceMessage {
    ...
    DeviceInquryResult inquery_result;
...
#define ClientCommandSyncTime_init_default       {0}
#define ClientCommand_init_default               {_ClientCommandType_MIN, ClientCommandConfigureHatch_init_default, ClientCommandSyncTime_init_default}
#define ClientInquiry_init_default               {_ClientInquiryType_MIN}
#define ClientMessage_init_default               {_ClientMessageType_MIN, 0, ClientCommand_init_default, ClientInquiry_init_default}
#define DeviceCommandResult_init_default         {_ClientCommandType_MIN, _DeviceResult_MIN}
#define DeviceInquryResult_init_default          {_ClientInquiryType_MIN, _DeviceResult_MIN, Version_init_default, HatchConfiguration_init_default}
...
#define ClientCommandSyncTime_init_zero          {0}
#define ClientCommand_init_zero                  {_ClientCommandType_MIN, ClientCommandConfigureHatch_init_zero, ClientCommandSyncTime_init_zero}
#define ClientInquiry_init_zero                  {_ClientInquiryType_MIN}
#define ClientMessage_init_zero                  {_ClientMessageType_MIN, 0, ClientCommand_init_zero, ClientInquiry_init_zero}
#define DeviceCommandResult_init_zero            {_ClientCommandType_MIN, _DeviceResult_MIN}
#define DeviceInquryResult_init_zero             {_ClientInquiryType_MIN, _DeviceResult_MIN, Version_init_zero, HatchConfiguration_init_zero}
...
#define ClientCommandSyncTime_unix_epoch_tag     1
#define ClientInquiry_type_tag                   1
...
extern const pb_field_t ClientCommandSyncTime_fields[2];
extern const pb_field_t ClientCommand_fields[4];
extern const pb_field_t ClientInquiry_fields[2];
...
#define ClientCommandSyncTime_size               11
#define ClientCommand_size                       127
#define ClientInquiry_size                       2
#define ClientMessage_size                       141
